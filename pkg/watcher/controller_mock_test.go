...
// Source: vendor/sigs.k8s.io/controller-runtime/pkg/controller/controller.go
...
func (m *MockController) Watch(src source.Source, eventhandler handler.EventHandler, predicates ...predicate.Predicate) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{src, eventhandler}
...
func (mr *MockControllerMockRecorder) Watch(src, eventhandler interface{}, predicates ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{src, eventhandler}, predicates...)
